...
export default function AceroPage() {
    ...
    const items = [
        { id: 1, name: 'Collar Galáctico', price: 79.99, image: '/placeholder.svg?height=400&width=300' },
        { id: 2, name: 'Pulsera Nebulosa', price: 59.99, image: '/placeholder.svg?height=400&width=300' },
        { id: 3, name: 'Anillo Estelar', price: 49.99, image: '/placeholder.svg?height=400&width=300' },
    ]
    ...
    return (
        <div >
            ...
            <main className="container mx-auto px-4 py-12">
                <h2 className="text-4xl font-thin text-center mb-12">Colección de Acero</h2>
